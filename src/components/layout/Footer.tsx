          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="space-y-4">
                <li>
                  <a href="mailto:bqsolution26@gmail.com" className="flex items-start gap-3 text-background/35 hover:text-background/60 transition-colors group">
                    <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-colors">
                      <Mail size={14} className="text-primary" />
                    </div>
                    <span className="text-sm pt-1.5">bqsolution26@gmail.com</span>
                  </a>
                </li>
                <li>
                  <a href="tel:+923708099033" className="flex items-start gap-3 text-background/35 hover:text-background/60 transition-colors group">
                    <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-colors">
                      <Phone size={14} className="text-primary" />
                    </div>
                    <span className="text-sm pt-1.5">+92-3708099033</span>
                  </a>
                </li>
