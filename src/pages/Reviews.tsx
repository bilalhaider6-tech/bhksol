...
const testimonials = [
  { id: 1, name: "Sarah Johnson", role: "CEO", company: "TechStart Inc.", content: "BHK Solutions transformed our online presence completely. Our leads increased by 300% within the first month! The team was professional, responsive, and truly understood our vision.", rating: 5, featured: true },
  ...
  { id: 3, name: "Emily Rodriguez", role: "Marketing Director", company: "StyleHub Fashion", content: "The best investment we made for our business. The website pays for itself every single month through increased online sales. BHK Solutions is truly outstanding.", rating: 5, featured: true },
  ...
  { id: 5, name: "Amanda White", role: "Partner", company: "LegalPro Associates", content: "As a law firm, we needed a website that conveyed trust and professionalism. BHK Solutions delivered exactly that. Our clients often compliment our online presence.", rating: 5, featured: false },
  ...
  { id: 7, name: "Jennifer Lee", role: "Founder", company: "Bloom Florist", content: "From start to finish, working with BHK Solutions was a pleasure. They were patient with our requests and delivered a beautiful, functional website on time.", rating: 5, featured: false },
  { id: 8, name: "Mark Wilson", role: "CEO", company: "TechCore Solutions", content: "We've worked with many agencies, but BHK Solutions stands out. Their attention to detail, technical expertise, and customer service are unmatched in the industry.", rating: 5, featured: false },
];
            ...
            <div className="relative rounded-3xl p-10 md:p-16 text-center text-primary-foreground overflow-hidden" style={{ background: "var(--gradient-primary)" }}>
              ...
              <div className="relative z-10">
                ...
                <p className="text-primary-foreground/90 mb-10 max-w-xl mx-auto text-lg">
                  Start your project today and experience the BHK Solutions difference.
                </p>
